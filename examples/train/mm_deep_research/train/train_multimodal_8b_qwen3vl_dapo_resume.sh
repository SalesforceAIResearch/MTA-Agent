...
export WANDB_API_KEY=""  # Set your own WANDB key
...
train_data=[$(pwd)/data/mm_deepsearch/infovqa_qw3vl/train_filtered_benchmark.parquet,\
$(pwd)/data/mm_deepsearch/infoseek_qw3vl/train_filtered_benchmark.parquet,\
$(pwd)/data/mm_deepsearch/fvqa_qw3vl/train_filtered_benchmark.parquet,\
$(pwd)/data/mm_deepsearch/okvqa_qw3vl/train_filtered_benchmark.parquet]
...
batch_size=32  # Number of prompts per batch (will be divided by 8 GPUs = 2 per GPU)
...
# Resume: hardcoded run name from the original run (do not regenerate timestamp)
run_name="multimodal_deepsearch-fsdp-agent-_export_share_beckypeng_models_qwen3-vl-8b-instruct-grpo-n8-b64-t1.0-lr2e-6-mm_deepsearch_multi-mmresearch-8b-dapo-poc-20260202-205002"
...
echo "Cleaning up stale NCCL/vLLM shared memory segments..."
rm -f /dev/shm/nccl-*
rm -f /dev/shm/vllm-*
echo "$(df -h /dev/shm | tail -1) (/dev/shm after cleanup)"
...
PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo_mm \
    ...
    trainer.resume_from_path=/export/home/becky/verl-tool-mm-deepsearch/checkpoints/multimodal_deepsearch/mm_deepsearch_multi/multimodal_deepsearch-fsdp-agent-_export_share_beckypeng_models_qwen3-vl-8b-instruct-grpo-n8-b64-t1.0-lr2e-6-mm_deepsearch_multi-mmresearch-8b-dapo-poc-20260202-205002/global_step_80 \
    trainer.val_before_train=True \
    trainer.default_hdfs_dir=null \
    trainer.default_local_dir=/export/home/becky/verl-tool-mm-deepsearch/checkpoints/multimodal_deepsearch/${dataset_id}/${run_name} \
