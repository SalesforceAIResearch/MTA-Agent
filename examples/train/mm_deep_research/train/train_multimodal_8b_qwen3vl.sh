...
export WANDB_API_KEY="local-e653fcc4d0e7192d39f39aceae96fc03aab22e28"
export WANDB_BASE_URL="https://salesforceairesearch.wandb.io"
export WANDB_ENTITY="becky-peng"
export WANDB_PROJECT="grpo_mmdr"

# Multimodal Deep Research Training Configuration - 8B Model (POC VERSION)
# Optimized for Qwen3-VL-8B with better capacity for ReAct pattern following
# 8B model should have better instruction following and tool use capabilities
...
# train_data=[$(pwd)/data/${dataset_name}/train_filtered.parquet]
...
val_data=[$(pwd)/data/mm_deepsearch/livevqa_news_qw3vl/val.parquet,\
$(pwd)/data/mm_deepsearch/infovqa_qw3vl/val.parquet,\
...
model_name=/export/share/beckypeng/mm_dr/output/grpo/step_100_0108 # 8B parameter vision-language model for better multimodal capabilities
...
max_action_length=5000  # Sufficient for tool calls
...
lr=1e-6  # Learning rate for 8B model
...
run_name_postfix="mmresearch-8b-poc"
