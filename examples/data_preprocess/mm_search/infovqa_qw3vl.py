...
"""
Preprocess the InfoVQA dataset to parquet format for model training (Qwen3VL version)
"""
import fire
import json
import datasets
...
def process_scenarios(
    ...
    for idx, scenario in enumerate(scenarios):
        try:
            ...
            data_id = scenario.get('id') or scenario.get('qid') or scenario.get('question_id') or f'infovqa_{start_idx + idx}'
...
# python -c 'import json; print(len(json.load(open("/export/share/beckypeng/mm_dr/data/infovqa/qa_formatted_train.json"))["scenarios"]))'
def main(
    qa_json_path: str = '/export/share/beckypeng/mm_dr/data/infovqa/qa_formatted_train.json',
    images_dir: str = '/export/share/beckypeng/mm_dr/data/infovqa/images',
    split: str = None,  # 'train', 'val', 'test', or None/'all' to process all splits
    local_dir: str = '/export/home/becky/verl-tool-mm-deepsearch/data/mm_deepsearch/infovqa_qw3vl',
    image_sep: str = "<image>",
    filter_len: int = None,
    image_url_prefix: str = 'https://cqin-public-data.s3.us-west-1.amazonaws.com/mm-deepsearch-sfr-2025/infovqa/images/',
    ...
    val_parquet: str = "/export/home/becky/verl-tool-mm-deepsearch/data/mm_deepsearch/infovqa_qw3vl/val.parquet",  # Path to existing val.parquet - questions will be excluded from train
    test_parquet: str = "/export/home/becky/verl-tool-mm-deepsearch/data/mm_deepsearch/infovqa_qw3vl/test.parquet",  # Path to existing test.parquet - questions will be excluded from train
):
    """
    Preprocess InfoVQA dataset to parquet format compatible with Qwen3VL model training.
    ...
    exclusion_set = load_exclusion_list(exclusion_file, 'infovqa') if exclusion_file else set()
...
python examples/data_preprocess/mm_search/infovqa_qw3vl.py --qa_json_path=data/mm_deepsearch/InfoVQA/qa_formatted.json --images_dir=data/mm_deepsearch/InfoVQA/images --local_dir=data/mm_deepsearch/infovqa_qw3vl

# Process only train split
python examples/data_preprocess/mm_search/infovqa_qw3vl.py --qa_json_path=data/mm_deepsearch/InfoVQA/qa_formatted.json --images_dir=data/mm_deepsearch/InfoVQA/images --split=train --local_dir=data/mm_deepsearch/infovqa_qw3vl

# Process with content length filter
python examples/data_preprocess/mm_search/infovqa_qw3vl.py --qa_json_path=data/mm_deepsearch/InfoVQA/qa_formatted.json --images_dir=data/mm_deepsearch/InfoVQA/images --local_dir=data/mm_deepsearch/infovqa_qw3vl --filter_len=8192
"""
