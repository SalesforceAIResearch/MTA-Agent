...
"""
Preprocess the FVQA dataset to parquet format for model training (Qwen3VL version)
"""
import fire
import json
import datasets
...
def process_scenarios(
    ...
    for idx, scenario in enumerate(scenarios):
        try:
            ...
            data_id = scenario.get('id') or scenario.get('qid') or scenario.get('question_id') or f'fvqa_{start_idx + idx}'
...
# python -c 'import json; print(len(json.load(open("/export/share/beckypeng/mm_dr/data/FVQA/qa_formatted_train.json"))["scenarios"]))'
def main(
    qa_json_path: str = '/export/share/beckypeng/mm_dr/data/FVQA/qa_formatted_train.json',
    images_dir: str = '/export/home/becky/verl-tool-mm-deepsearch/data/mm_deepsearch/fvqa_qw3vl/images',
    split: str = None,  # 'train', 'val', 'test', or None/'all' to process all splits
    local_dir: str = '/export/home/becky/verl-tool-mm-deepsearch/data/mm_deepsearch/fvqa_qw3vl',
    image_sep: str = "<image>",
    filter_len: int = None,
    image_url_prefix: str = 'https://cqin-public-data.s3.us-west-1.amazonaws.com/mm-deepsearch-sfr-2025/FVQA/images/',
    ...
    max_output: int = 2500,  # Maximum number of examples to output per split (applied after all filtering)
    val_parquet: str = "/export/home/becky/verl-tool-mm-deepsearch/data/mm_deepsearch/fvqa_qw3vl/val.parquet",  # Path to existing val.parquet - questions will be excluded from train
    test_parquet: str = "/export/home/becky/verl-tool-mm-deepsearch/data/mm_deepsearch/fvqa_qw3vl/test.parquet",  # Path to existing test.parquet - questions will be excluded from train
):
    """
    Preprocess FVQA dataset to parquet format compatible with Qwen3VL model training.
    ...
    exclusion_set = load_exclusion_list(exclusion_file, 'FVQA') if exclusion_file else set()
...
python examples/data_preprocess/mm_search/fvqa_qw3vl.py --qa_json_path=data/mm_deepsearch/FVQA/qa_formatted.json --images_dir=data/mm_deepsearch/FVQA/images --local_dir=data/mm_deepsearch/fvqa_qw3vl

# Process only train split
python examples/data_preprocess/mm_search/fvqa_qw3vl.py --qa_json_path=data/mm_deepsearch/FVQA/qa_formatted.json --images_dir=data/mm_deepsearch/FVQA/images --split=train --local_dir=data/mm_deepsearch/fvqa_qw3vl

# Process with content length filter
python examples/data_preprocess/mm_search/fvqa_qw3vl.py --qa_json_path=data/mm_deepsearch/FVQA/qa_formatted.json --images_dir=data/mm_deepsearch/FVQA/images --local_dir=data/mm_deepsearch/fvqa_qw3vl --filter_len=8192
"""
