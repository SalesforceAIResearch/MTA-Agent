...
| [Multimodal Deep Research](./mm_deep_research/README.md) | Training a model that can analyze images and text to answer questions by searching the web and running code | `web_text_to_text_search.py`, `web_text_to_img_search.py`, `web_url_reader.py`, `web_image_to_text.py`, `ipython_code.py` | TBD |
