...
export WANDB_PROJECT="dapo_mmdr_baseline"
...
train_data=[$(pwd)/data/mm_deepsearch/livevqa_news_qw3vl/train_filtered_baseline.parquet,\
$(pwd)/data/mm_deepsearch/fvqa_qw3vl/train_filtered_baseline.parquet]
...
run_name_postfix="mmresearch-8b-dapo-baseline"
